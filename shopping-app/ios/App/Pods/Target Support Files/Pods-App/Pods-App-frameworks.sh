...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RobingenzCapacitorScreenOrientation/RobingenzCapacitorScreenOrientation.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/LzdevelopersLazarilloMaps/LZSDKMaps.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/LzdevelopersLazarilloMaps/Mapbox.framework"
fi
